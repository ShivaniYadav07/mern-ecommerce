...
export const getAdminProduct = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${SERVER_ENDPOINT}/api/v1/admin/products`);
...
export const deleteProduct = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`${SERVER_ENDPOINT}/api/v1/admin/product/${id}`);
...
export const getProductDetails = (id) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(`${SERVER_ENDPOINT}/api/v1/product/${id}`);
...
export const newReview = (reviewData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`${SERVER_ENDPOINT}/api/v1/review`, reviewData, config);
...
export const getAllReviews = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${SERVER_ENDPOINT}/api/v1/reviews?id=${id}`);
...
export const deleteReviews = (reviewId, productId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(
      `${SERVER_ENDPOINT}/api/v1/reviews?id=${reviewId}&productId=${productId}`
    );
